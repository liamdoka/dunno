...
mixin _$ColorPaletteModel {
 ...
 String get title; List<SimpleColor> get colors; bool get isFavorite;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ColorPaletteModel&&(identical(other.title, title) || other.title == title)&&const DeepCollectionEquality().equals(other.colors, colors)&&(identical(other.isFavorite, isFavorite) || other.isFavorite == isFavorite));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,title,const DeepCollectionEquality().hash(colors),isFavorite);

@override
String toString() {
  return 'ColorPaletteModel(title: $title, colors: $colors, isFavorite: $isFavorite)';
}
...
@useResult
$Res call({
 String title, List<SimpleColor> colors, bool isFavorite
});
...
/// Create a copy of ColorPaletteModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? title = null,Object? colors = null,Object? isFavorite = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String title,  List<SimpleColor> colors,  bool isFavorite)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ColorPaletteModel() when $default != null:
return $default(_that.title,_that.colors,_that.isFavorite);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String title,  List<SimpleColor> colors,  bool isFavorite)  $default,) {final _that = this;
switch (_that) {
case _ColorPaletteModel():
return $default(_that.title,_that.colors,_that.isFavorite);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String title,  List<SimpleColor> colors,  bool isFavorite)?  $default,) {final _that = this;
switch (_that) {
case _ColorPaletteModel() when $default != null:
return $default(_that.title,_that.colors,_that.isFavorite);case _:
  return null;
...
class _ColorPaletteModel extends ColorPaletteModel {
  const _ColorPaletteModel({required this.title, required final  List<SimpleColor> colors, this.isFavorite = false}): _colors = colors,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ColorPaletteModel&&(identical(other.title, title) || other.title == title)&&const DeepCollectionEquality().equals(other._colors, _colors)&&(identical(other.isFavorite, isFavorite) || other.isFavorite == isFavorite));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,title,const DeepCollectionEquality().hash(_colors),isFavorite);
...
/// Create a copy of ColorPaletteModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? title = null,Object? colors = null,Object? isFavorite = null,}) {
