...
@useResult
$Res call({
 String title, List<SimpleColor> colors, String? id, DunnoStatsModel? stats, bool isFavorite
});
...
/// Create a copy of ColorPaletteModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? title = null,Object? colors = null,Object? id = freezed,Object? stats = freezed,Object? isFavorite = null,}) {
  return _then(_self.copyWith(
title: null == title ? _self.title : title // ignore: cast_nullable_to_non_nullable
as String,colors: null == colors ? _self.colors : colors // ignore: cast_nullable_to_non_nullable
as List<SimpleColor>,id: freezed == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String?,stats: freezed == stats ? _self.stats : stats // ignore: cast_nullable_to_non_nullable
as DunnoStatsModel?,isFavorite: null == isFavorite ? _self.isFavorite : isFavorite // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
/// Create a copy of ColorPaletteModel
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String title,  List<SimpleColor> colors,  String? id,  DunnoStatsModel? stats,  bool isFavorite)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ColorPaletteModel() when $default != null:
return $default(_that.title,_that.colors,_that.id,_that.stats,_that.isFavorite);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String title,  List<SimpleColor> colors,  String? id,  DunnoStatsModel? stats,  bool isFavorite)  $default,) {final _that = this;
switch (_that) {
case _ColorPaletteModel():
return $default(_that.title,_that.colors,_that.id,_that.stats,_that.isFavorite);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String title,  List<SimpleColor> colors,  String? id,  DunnoStatsModel? stats,  bool isFavorite)?  $default,) {final _that = this;
switch (_that) {
case _ColorPaletteModel() when $default != null:
return $default(_that.title,_that.colors,_that.id,_that.stats,_that.isFavorite);case _:
  return null;
...
class _ColorPaletteModel extends ColorPaletteModel {
   _ColorPaletteModel({required this.title, required final  List<SimpleColor> colors, final  String? id, final  DunnoStatsModel? stats, this.isFavorite = false}): _colors = colors,super._(id: id, stats: stats);
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,title,const DeepCollectionEquality().hash(_colors),id,stats,isFavorite);

@override
String toString() {
  return 'ColorPaletteModel(title: $title, colors: $colors, id: $id, stats: $stats, isFavorite: $isFavorite)';
}
...
/// Create a copy of ColorPaletteModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? title = null,Object? colors = null,Object? id = freezed,Object? stats = freezed,Object? isFavorite = null,}) {
